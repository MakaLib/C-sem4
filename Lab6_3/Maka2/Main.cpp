...
// sie, a wynik jego dzialania byl taki sam jak podany na koÅ„cu tego
// pliku.
...
// przygotowanych plikow oprÃ³cz makefile)
...
int main ()
{
  ...
  int size1 [] = {3, 9, 5, 1};
  Array& firstArray = CreateArray (size1, sizeof(size1)/sizeof(int));
  size1[1] = 100; 		
  ...
  const int size2 [] = {7, 2};
  Array& secondArray = CreateArray (size2, sizeof(size2)/sizeof(int));
